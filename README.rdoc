...
yet published so it is needed download gem file here on github and than just use:

gem install redxml-0.9.8
...
Project uses some libraries, which are not part of this library itself. If you used gem to install, those
libraries were automatically installed, otherwise you have to install the by hand, see Installation.
